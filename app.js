...
document.addEventListener('DOMContentLoaded', function() {
            ...
            function getLocation() {
                ...
                if ("geolocation" in navigator) {
                    navigator.geolocation.getCurrentPosition(function(position) {
                        ...
                        console.error("Error: " + error.message);
                        updateLocationStatus('Unable to retrieve location. Please ensure location services are enabled.');
                    ...
                    updateLocationStatus('Geolocation is not supported by your browser. Please enter your location manually.');
                    locationInput.readOnly = false;
                }
            }
            ...
            // Refresh location when the button is clicked
